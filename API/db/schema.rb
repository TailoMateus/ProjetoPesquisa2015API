...
ActiveRecord::Schema.define(version: 20151007175400) do

  # These are extensions that must be enabled in order to support this database
  enable_extension "plpgsql"

  create_table "cadastro_completo_prospectos", force: :cascade do |t|
  ...
  create_table "historico_prospectos", force: :cascade do |t|
    t.string   "descricao"
    t.integer  "prospecto_id"
